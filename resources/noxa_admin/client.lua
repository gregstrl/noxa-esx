...
-- =====================================================================
local mainMenu = MenuV:CreateMenu('NOXA ADMIN', 'Menu staff', 'topleft', 245, 65, 65, 'size-110', 'default', 'menuv', 'noxa_admin_mainMenu')

local playersMenu     = MenuV:CreateMenu('Joueurs', 'Liste des connectés', 'topleft', 245, 65, 65, 'size-110', 'default', 'menuv', 'noxa_admin_playersMenu')
local playerActMenu   = MenuV:CreateMenu('Joueur', 'Actions', 'topleft', 245, 65, 65, 'size-110', 'default', 'menuv', 'noxa_admin_playerActMenu')
local staffMenu       = MenuV:CreateMenu('Moi / Staff', 'Outils staff', 'topleft', 245, 65, 65, 'size-110', 'default', 'menuv', 'noxa_admin_staffMenu')
local tpMenu          = MenuV:CreateMenu('Téléportation', 'Se déplacer', 'topleft', 245, 65, 65, 'size-110', 'default', 'menuv', 'noxa_admin_tpMenu')
local tpLocMenu       = MenuV:CreateMenu('Lieux', 'Téléportation rapide', 'topleft', 245, 65, 65, 'size-110', 'default', 'menuv', 'noxa_admin_tpLocMenu')
local vehMenu         = MenuV:CreateMenu('Véhicules', 'Gestion véhicules', 'topleft', 245, 65, 65, 'size-110', 'default', 'menuv', 'noxa_admin_vehMenu')
local ecoMenu         = MenuV:CreateMenu('Économie', 'Gestion argent', 'topleft', 245, 65, 65, 'size-110', 'default', 'menuv', 'noxa_admin_ecoMenu')
local ecoPickMenu     = MenuV:CreateMenu('Économie', 'Choisir un joueur', 'topleft', 245, 65, 65, 'size-110', 'default', 'menuv', 'noxa_admin_ecoPickMenu')
local ecoActMenu      = MenuV:CreateMenu('Économie', 'Actions argent', 'topleft', 245, 65, 65, 'size-110', 'default', 'menuv', 'noxa_admin_ecoActMenu')
local jobsMenu        = MenuV:CreateMenu('Jobs', 'Choisir un joueur', 'topleft', 245, 65, 65, 'size-110', 'default', 'menuv', 'noxa_admin_jobsMenu')
local jobListMenu     = MenuV:CreateMenu('Jobs', 'Choisir un job', 'topleft', 245, 65, 65, 'size-110', 'default', 'menuv', 'noxa_admin_jobListMenu')
local sanctionsMenu   = MenuV:CreateMenu('Sanctions', 'Warns & bans', 'topleft', 245, 65, 65, 'size-110', 'default', 'menuv', 'noxa_admin_sanctionsMenu')
local bansMenu        = MenuV:CreateMenu('Bans', 'Bans actifs', 'topleft', 245, 65, 65, 'size-110', 'default', 'menuv', 'noxa_admin_bansMenu')
local annonceMenu     = MenuV:CreateMenu('Annonces', 'Communication', 'topleft', 245, 65, 65, 'size-110', 'default', 'menuv', 'noxa_admin_annonceMenu')
local weatherMenu     = MenuV:CreateMenu('Météo & Temps', 'Monde', 'topleft', 245, 65, 65, 'size-110', 'default', 'menuv', 'noxa_admin_weatherMenu')
local reportsMenu     = MenuV:CreateMenu('Reports', 'Signalements', 'topleft', 245, 65, 65, 'size-110', 'default', 'menuv', 'noxa_admin_reportsMenu')
local reportActMenu   = MenuV:CreateMenu('Report', 'Actions', 'topleft', 245, 65, 65, 'size-110', 'default', 'menuv', 'noxa_admin_reportActMenu')
local panelsMenu      = MenuV:CreateMenu('Panels NUI', 'Interfaces Noxa', 'topleft', 245, 65, 65, 'size-110', 'default', 'menuv', 'noxa_admin_panelsMenu')
